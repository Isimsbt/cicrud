            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
              <form method="post" action="" id="loginForm" novalidate>
                ...
                <div data-mdb-input-init class="form-outline mb-4">
                    <input type="email" id="e" class="form-control form-control-lg" placeholder="Entrez une adresse email valide" required />
                    <label class="form-label" for="e">Adresse email</label>
                ...
                <div data-mdb-input-init class="form-outline mb-3">
                    <input type="password" id="p" class="form-control form-control-lg" placeholder="Entrez un mot de passe" required pattern="(?=.*\d)(?=.*[a-zA-Z])(?=.*[!@#$%^&*]).{8,}" />
                    <label class="form-label" for="p">Mot de passe</label>
                    <div class="invalid-feedback">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="form-check mb-0">
                        <input class="form-check-input me-2" type="checkbox" value="" id="c" />
