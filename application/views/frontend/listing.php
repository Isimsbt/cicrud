  ...
  <body>
        ...
        <div class="container">
          <div class="row align-items-end ">
            <div class="col-lg-5">
              ...
              <div class="intro">
                <h1><strong>véhicule</strong></h1>
                <div class="custom-breadcrumbs"><a href="http://localhost/cicrud/frontend/page/index">Accuiel</a> <span class="mx-2">/</span> <strong>véhicule</strong></div>
              </div>
    ...
    <div class="site-section bg-light">
      <div class="container">
        <div class="row">
          <div class="col-lg-7">
            <h2 class="section-heading"><strong>véhicule liste </strong></h2>
            <p class="mb-5"></p>    
          </div>
        </div>
