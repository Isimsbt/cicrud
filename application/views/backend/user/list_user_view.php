...
<svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="20" height="20"><path d="m14,7.015V.474c.913.346,1.753.879,2.465,1.59l3.484,3.486c.712.711,1.245,1.551,1.591,2.464h-6.54c-.552,0-1-.449-1-1Zm7.976,3h-6.976c-1.654,0-3-1.346-3-3V.038c-.161-.011-.322-.024-.485-.024h-4.515C4.243.015,2,2.258,2,5.015v14c0,2.757,2.243,5,5,5h10c2.757,0,5-2.243,5-5v-8.515c0-.163-.013-.324-.024-.485Zm-6.976,5.985h-6c-.552,0-1-.448-1-1s.448-1,1-1h6c.552,0,1,.448,1,1s-.448,1-1,1Z"/></svg>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="<?=base_url()?>backend/user/edit/<?=$client['ID_client']?>" class="btn btn-sm btn-primary">Edit</a>
                  <a href="<?=base_url()?>backend/user/delete/<?=$client['ID_client']?>" onclick="return confirm('Are you sure want to delete this client ?')" class="btn btn-sm btn-danger">Delete</a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
          </table>
					<a href="<?= base_url('backend/user/add') ?>" class="btn btn-sm btn-primary">Add New user</a>
    ...
    <script>window.jQuery || document.write('<script src="<?php echo base_url('assets/Bootstrap4/js/vendor/jquery.slim.min.js')?>"><\/script>')</script><script src="<?php echo base_url('assets/Bootstrap4/dist/js/bootstrap.bundle.min.js')?>"></script>

    <script src="https://cdn.jsdelivr.net/npm/feather-icons@4.28.0/dist/feather.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/chart.js@2.9.4/dist/Chart.min.js"></script>
    <script src="<?php echo base_url('assets/Bootstrap4/dashboard/dashboard.js')?>"></script>
  </body>
</html>
