          ...
          <div class="row align-items-end ">
            <div class="col-lg-5">
              ...
              <div class="intro">
                ...
                <div class="custom-breadcrumbs"><a href="index.html">Accuiel</a> <span class="mx-2">/</span> <strong>Contact</strong></div>
              </div>
    ...
    <div class="site-section bg-light" id="contact-section">
      <div class="container">
        ...
        <div class="col-7 text-center mb-5">
          ...
          <p>Pour toute demande ou information complémentaire, n'hésitez pas à nous joindre. Notre équipe est à votre service.</p>
            ...
            <div class="bg-white p-3 p-md-5">
              ...
              <ul class="list-unstyled footer-link">
                <li class="d-block mb-3">
                  ...
                  <span>tunisia</span></li>
                <li class="d-block mb-3"><span class="d-block text-black">telephone:</span><span>+1 242 4942 290</span></li>
