        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="updateForm" method="post" action="<?= base_url('backend/taxi/edit/' . $matricule) ?>">
                        <div class="mb-3">
                            <label for="marque" class="form-label">Marque</label>
                            <input type="text" name="marque" value="<?= $taxi->marque ?>" class="form-control" id="marque" required>
                        </div>
                        <div class="mb-3">
                            <label for="modele" class="form-label">Modèle</label>
                            <input type="text" name="modele" value="<?= $taxi->modele ?>" class="form-control" id="modele" required>
                        </div>
                        <div class="mb-3">
                            <label for="disponibilite" class="form-label">Disponibilité</label>
                            <input type="text" name="disponibilite" value="<?= $taxi->disponibilite ?>" class="form-control" id="disponibilite" required>
                        </div>
