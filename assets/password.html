          ...
          <div class="card card-registration my-4">
            <div class="row g-0">
              <div class="col-xl-6 d-none d-xl-block">
                <img src="images/login.png" alt="Sample photo" class="img-fluid"
                ...
                <div class="card-body p-md-5 text-black">
                  ...
                  <form id="form" action="" method="post" novalidate>
                    ...
                    <div data-mdb-input-init class="form-outline mb-4">
                        <input type="email" id="em" class="form-control form-control-lg" placeholder="Entrez une adresse e-mail" required/>
                    ...
                    <div class="mt-3">
                        <p class="mb-1"><a href="espace_client.html">Retour à la connexion</a></p>
                    </div>
                </form>
