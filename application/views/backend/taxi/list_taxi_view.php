                ...
                <tbody>
                    <?php foreach ($taxis as $taxi) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('backend/taxi/edit/' . $taxi->matricule) ?>" class="btn btn-primary">Modifier</a>
                                <a href="<?= base_url('backend/taxi/delete/' . $taxi->matricule) ?>" class="btn btn-danger">Supprimer</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
