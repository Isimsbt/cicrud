...
<div class="container">
    <div class="row">
            ...
            <div class="card-body">
                ...
                <form id="addForm" method="post" action="<?= base_url('backend/agence/add') ?>">
                    <div class="mb-3">
                        <label for="nom" class="form-label">Nom de l'agence</label>
                        <input type="text" name="nom" placeholder="Nom de l'agence" class="form-control" id="nom" required>
                    ...
                    <div class="mb-3">
                        ...
                        <?= form_error('adresse', '<div class="text-danger">', '</div>') ?>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" name="email" id="email" placeholder="Email" aria-describedby="emailHelp" required>
                        <?= form_error('email', '<div class="text-danger">', '</div>') ?>
                    </div>
                    <button type="submit" id="addButton" class="btn btn-sm btn-primary">Ajouter</button>
                </form>
            </div>
        </div>
</div>
...
document.getElementById('addForm').addEventListener('submit', function(event) {
    ...
    // CSRF Token (if applicable, otherwise remove this part)
    ...
    xhr.onload = function() {
        if (xhr.status === 200) {
            ...
            alert('Erreur lors de l\'ajout de l\'agence. Veuillez réessayer.');
        }
    };

    xhr.onerror = function() {
        console.error('Request error');
        alert('Erreur de requête. Veuillez réessayer.');
    };
