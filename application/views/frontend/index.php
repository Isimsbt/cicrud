  ...
  <body>
    ...
    <div class="site-wrap" id="home-section">
            ...
            <div class="col-lg-10">
              ...
              <div class="row mb-5">
                <div class="col-lg-7 intro">
                  <h1><strong>votre taxi</strong> est à portée de main.</h1>
                </div>
              </div>
                ...
                <div class="row align-items-center">
                  ...
                  <div class="mb-3 mb-md-0 col-md-3">
                    <div class="form-control-wrap">
                      <input type="text" id="cf-3" placeholder="date debut" class="form-control datepicker px-3">
                  ...
                  <div class="mb-3 mb-md-0 col-md-3">
                    <div class="form-control-wrap">
                      <input type="text" id="cf-4" placeholder="date fin" class="form-control datepicker px-3">
                      <span class="icon icon-date_range"></span>
                    </div>
                  </div>
                  <div class="mb-3 mb-md-0 col-md-3">
                    <input type="submit" value="Rechercher un plan" class="btn btn-primary btn-block py-3">
                  </div>
                </div>
      ...
      <div class="site-section">
        <div class="container">
          <h2 class="section-heading"><strong>comment ca marche ?</strong></h2>
          <p class="mb-5">Étapes faciles pour vous aider à démarrer</p>    
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
              <div class="step">
                ...
                <div class="step-inner">
                  ...
                  <h3>Sélection une voiture</h3>
                  <p>Explorez notre flotte de taxis touristiques et choisissez celui qui correspond à vos besoins.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 mb-4 mb-lg-0">
              <div class="step">
                ...
                <div class="step-inner">
                  ...
                  <p>Fournissez vos informations personnelles et les détails de votre réservation.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 mb-4 mb-lg-0">
              <div class="step">
                ...
                <div class="step-inner">
                  ...
                  <p>Finalisez votre réservation en procédant au paiement sécurisé.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-lg-4 ml-auto order-lg-1">
              <h3 class="mb-4 section-heading"><strong>Profitez de notre promotion pour la location de voiture</strong></h3>
              <p class="mb-5">Profitez facilement de notre promotion pour la location de voiture. Réservez maintenant et bénéficiez de réductions exceptionnelles. Explorez des destinations pittoresques avec notre flotte bien entretenue. Voyagez confortablement et avec style. Ne manquez pas cette opportunité unique. Réservez dès aujourd'hui !

              </p>
              
              <p><a href="#" class="btn btn-primary">Rencontrez-les dès maintenant</a></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="site-section bg-light">
        <div class="container">
          <div class="row">
            <div class="col-lg-7">
              <h2 class="section-heading"><strong>Nos taxis</strong></h2>
              <p class="mb-5"></p>    
            </div>
          </div>
              ...
              <div class="listing d-block  align-items-stretch">
                ...
                <div class="listing-contents h-100">
                  ...
                  <div class="rent-price">
                    <strong>$150.00</strong><span class="mx-1">/</span>day
                  </div>
                  <div class="d-block d-md-flex mb-3 border-bottom pb-3">
                    <div class="listing-feature pr-4">
                      <span class="caption">pagage:</span>
                      <span class="number">8</span>
                    </div>
                    <div class="listing-feature pr-4">
                      <span class="caption">portes:</span>
                      <span class="number">4</span>
                    </div>
                    <div class="listing-feature pr-4">
                      <span class="caption">Passegere:</span>
                      <span class="number">4</span>
                    </div>
                  </div>
                  <div>
              ...
              <div class="listing d-block  align-items-stretch">
                ...
                <div class="listing-contents h-100">
                  ...
                  <div class="d-block d-md-flex mb-3 border-bottom pb-3">
                    ...
                    <div class="listing-feature pr-4">
                      <span class="caption">passagere:</span>
                      <span class="number">4</span>
                    </div>
                  </div>
                  <div>
    ...
    <div class="site-section">
      <div class="container">
          ...
          <div class="col-lg-4 mb-5">
            <div class="service-1 dark">
              <span class="elementor-icon elementor-animation-">
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="60" fill="currentColor" class="bi bi-journal-check" viewBox="0 0 16 16">
              ...
              <div class="service-1-contents">
                <h3>Service fiable et efficace</h3>
                <p>Nos chauffeurs sont équipés d’une application leur indiquant avec précision l’heure et l’emplacement de rendez-vous</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 mb-5">
            <div class="service-1 dark">
              ...
              <div class="service-1-contents">
                <h3>Ponctualité</h3>
                <p>Le taxi devra se libérer à l’avance pour s’assurer d’être à l’heure au point de rendez-vous. Il vous contactera par téléphone</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 mb-5">
        ...
        <p>Nous suivons en temps réel les taxis sur notre système, et conservons tous les historiques de localisations et courses effectuées.</p>
