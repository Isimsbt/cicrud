        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="<?= base_url() ?>backend/taxi/add">
                        <div class="mb-3">
                            <label for="matricule" class="form-label">Matricule</label>
                            <input type="text" name="matricule" placeholder="Matricule" class="form-control" id="matricule" value="<?= set_value('matricule'); ?>">
                            <?= form_error('matricule', '<div class="text-danger">', '</div>'); ?>
                        </div>
                        <div class="mb-3">
                            <label for="marque" class="form-label">Marque</label>
                            <input type="text" name="marque" placeholder="Marque" class="form-control" id="marque" value="<?= set_value('marque'); ?>">
                            <?= form_error('marque', '<div class="text-danger">', '</div>'); ?>
                        </div>
                        <div class="mb-3">
                            <label for="modele" class="form-label">Modèle</label>
                            <input type="text" class="form-control" name="modele" id="modele" placeholder="Modèle" value="<?= set_value('modele'); ?>">
                            <?= form_error('modele', '<div class="text-danger">', '</div>'); ?>
                        </div>
                        <div class="mb-3">
                            <label for="disponibilite" class="form-label">Disponibilité</label>
                            <input type="text" class="form-control" name="disponibilite" id="disponibilite" placeholder="Disponibilité" value="<?= set_value('disponibilite'); ?>">
                            <?= form_error('disponibilite', '<div class="text-danger">', '</div>'); ?>
                        </div>
