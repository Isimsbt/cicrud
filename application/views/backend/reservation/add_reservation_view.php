...
<div class="container">
    <div class="row">
            ...
            <div class="card-body">
                ...
                <form method="post" action="<?= base_url('backend/reservation/add') ?>">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="matricule" class="form-label">Taxi ID</label>
                        <input type="text" name="matricule" placeholder="Taxi ID" class="form-control" id="matricule">
                    </div>
                    <div class="mb-3">
